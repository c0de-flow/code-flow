...
const SendButton = ({ text }: { text: string }) => {
  return (
    <div className="relative mt-3 p-8 text-blue-300  cursor-pointer font-abhaya text-4xl flex justify-center items-center w-44 bg-transparent border-none group">
      {/* الخطوط الأربعة */}
      ...
      {/* النص */}
      <span className="text-blue-300 glow-effect group-hover:text-white transition-colors duration-900">
        {text}
      </span>
    </div>
  );
